...
import { FeatureFlagsClient } from "./api/resources/featureFlags/client/Client.js";
import type { BaseClientOptions, BaseRequestOptions } from "./BaseClient.js";
import { type NormalizedClientOptionsWithAuth, normalizeClientOptionsWithAuth } from "./BaseClient.js";
import * as core from "./core/index.js";

export declare namespace LogoasApiClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class LogoasApiClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<LogoasApiClient.Options>;
    protected _featureFlags: FeatureFlagsClient | undefined;

    constructor(options: LogoasApiClient.Options) {
