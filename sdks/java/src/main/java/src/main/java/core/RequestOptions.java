...
public final class RequestOptions {
  ...
  private RequestOptions(String apiKey, String user, Optional<Integer> timeout,
  ...
  public static class Builder {
    ...
    public RequestOptions build() {
      return new RequestOptions(apiKey, user, timeout, timeoutTimeUnit, headers, headerSuppliers, queryParameters, queryParameterSuppliers);
    }
  }
}
