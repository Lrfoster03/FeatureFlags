...
public class AsyncLogoasApiClientBuilder {
   ...
   * Sets apiKey
   */
  public AsyncLogoasApiClientBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
   ...
   * Sets user
   */
  public AsyncLogoasApiClientBuilder user(String user) {
    this.user = user;
    return this;
  }

  public AsyncLogoasApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public AsyncLogoasApiClientBuilder url(String url) {
   ...
   */
  public AsyncLogoasApiClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncLogoasApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncLogoasApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncLogoasApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncLogoasApiClientBuilder addHeader(String name, String value) {
  ...
  protected void setCustomHeaders(ClientOptions.Builder builder) {
    if (this.user != null) {
      builder.addHeader("user", this.user);
    }
  }
  ...
  public AsyncLogoasApiClient build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey");
    }
    validateConfiguration();
    return new AsyncLogoasApiClient(buildClientOptions());
  }
}
