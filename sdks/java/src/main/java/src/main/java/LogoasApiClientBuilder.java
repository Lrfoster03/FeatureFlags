...
public class LogoasApiClientBuilder {
   ...
   * Sets apiKey
   */
  public LogoasApiClientBuilder apiKey(String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
   ...
   * Sets user
   */
  public LogoasApiClientBuilder user(String user) {
    this.user = user;
    return this;
  }

  public LogoasApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public LogoasApiClientBuilder url(String url) {
   ...
   */
  public LogoasApiClientBuilder timeout(int timeout) {
   ...
   */
  public LogoasApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public LogoasApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public LogoasApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public LogoasApiClientBuilder addHeader(String name, String value) {
  ...
  public LogoasApiClient build() {
    if (apiKey == null) {
      throw new RuntimeException("Please provide apiKey");
    }
    validateConfiguration();
    return new LogoasApiClient(buildClientOptions());
  }
}
