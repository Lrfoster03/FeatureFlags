...
class LogoasApi:
    ...
    environment : LogoasApiEnvironment
        The environment to use for requests from the client. from .environment import LogoasApiEnvironment



        Defaults to LogoasApiEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: LogoasApiEnvironment = LogoasApiEnvironment.PRODUCTION,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: LogoasApiEnvironment) -> str:
