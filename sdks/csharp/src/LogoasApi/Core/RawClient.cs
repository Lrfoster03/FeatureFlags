...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::LogoasApi.Core.ApiResponse> SendRequestAsync(
        global::LogoasApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::LogoasApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::LogoasApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::LogoasApi.Core.BaseRequest request)
    {
