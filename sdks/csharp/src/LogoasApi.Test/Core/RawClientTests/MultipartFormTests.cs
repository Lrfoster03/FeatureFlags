...
namespace LogoasApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static LogoasApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new LogoasApi.Core.MultipartFormRequest
        {
